...
DOMAINS                       DTGENRTYPEReserved WordsL8Type of PL/SQL reserved words and keywords
...
TABLES                        DTGENRWreserved_words20NONEXTRAPL/SQL reserved words and keywords
...
DOMAIN_VALUES                 DTGENRTYPEreserved1PL/SQL reserved words, cannot be useed as ordinary user-defined identifiers.
DOMAIN_VALUES                 DTGENRTYPEkeyword2PL/SQL keywords, not recommended for use as ordinary user-defined identifiers
...
TAB_COLS                      DTGENRWkeyword11XVARCHAR230L1PL/SQL reserved word or keyword
TAB_COLS                      DTGENRWrtype2XDTGENRTYPE1Type of PL/SQL reserved word or keyword
