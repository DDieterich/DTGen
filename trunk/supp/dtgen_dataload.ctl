...
into table INDEXES_ACT APPEND when key = 'INDEXES                       ' fields terminated by ''
   (key FILLER position(1:31), tab_cols_nk1 CHAR, tab_cols_nk2 CHAR, tab_cols_nk3 CHAR, tag CHAR, seq FLOAT EXTERNAL, uniq CHAR)
BEGINDATA
...
DOMAIN_VALUES                 DTGENTTYPE1EFFAn effectivity table type with begin and end timestamps
DOMAIN_VALUES                 DTGENTTYPE2LOGA log table type without begin and end timestamps
DOMAIN_VALUES                 DTGENTTYPE3NONNo table type (without begin/end timestamps)
...
TAB_COLS                      DTGENAPPdbid7VARCHAR28UDatabase link connect string for mid-tier connections to the centralized database server
TAB_COLS                      DTGENAPPdb_auth8VARCHAR2100Database link authorization for mid-tier connections to the centralized database server
...
INDEXES                       DTGENAPPnameux11X
INDEXES                       DTGENDOMapplication_idux11X
INDEXES                       DTGENDOMnameux12X
INDEXES                       DTGENDVdomain_idux11X
INDEXES                       DTGENDVsequx12X
INDEXES                       DTGENTABapplication_idux11X
INDEXES                       DTGENTABnameux12X
INDEXES                       DTGENTABapplication_idux21X
INDEXES                       DTGENTABsequx22X
INDEXES                       DTGENCOLtable_idux11X
INDEXES                       DTGENCOLsequx12X
INDEXES                       DTGENEXCapplication_idux21X
INDEXES                       DTGENEXCnameux22X
