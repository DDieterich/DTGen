...
TAB_COLS                      DTGENAPPts_onln_data11VARCHAR230LDefault tableapace name for on-line data tables
TAB_COLS                      DTGENAPPts_onln_indx12VARCHAR230LDefault tablespace name for on-line indexes
TAB_COLS                      DTGENAPPts_hist_data13VARCHAR230LDefault tablespace name for history data tables
TAB_COLS                      DTGENAPPts_hist_indx14VARCHAR230LDefault tablespace name for history indexes
TAB_COLS                      DTGENAPPts_null_override10DTGENFLAGFlag to override all tablespace names to null
