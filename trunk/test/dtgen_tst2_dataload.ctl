...
--    Full data dump of the TST2 application
--    
...
BEGINDATA
APPLICATIONS                  TST2Test Application 2Test Application 2test_onln_data_defaulttest_onln_indx_defaulttest_hist_data_defaulttest_hist_indx_default*** This is only another test ***
TABLES                        TST2T2ANt2a_non10NONDTCtest_onln_data_specialtest_onln_indx_specialtest_hist_data_specialtest_hist_indx_specialDatatype Support for Columns Test Table, NON Table Type
TABLES                        TST2T2ALt2a_log11LOGDTCtest_onln_data_specialtest_onln_indx_specialtest_hist_data_specialtest_hist_indx_specialDatatype Support for Columns Test Table, LOG Table Type
TABLES                        TST2T2AEt2a_eff12EFFDTCDatatype Support for Columns Test Table, EFF Table Type
TAB_COLS                      TST2T2AEseq11NUMBERSequenced Natural Key
TAB_COLS                      TST2T2AEstr11VARCHAR24000Plain String
TAB_COLS                      TST2T2ALseq11NUMBERSequenced Natural Key
TAB_COLS                      TST2T2ALstr11VARCHAR24000Plain String
TAB_COLS                      TST2T2ANseq11NUMBERSequenced Natural Key
TAB_COLS                      TST2T2ANstr11VARCHAR24000Plain String
