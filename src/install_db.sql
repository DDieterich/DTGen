...
create package applications_pop
is

   -- Package Applications_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
   --    
   --    Generated by DTGen (http://code.google.com/p/dtgen)
   ...
   function tab_to_col
      ...
      return col_type;
end applications_pop;
/
select 'APPLICATIONS_POP' as "Package:"
 from  user_errors
 where name = 'APPLICATIONS_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
comment on column applications.db_schema is 'Name of the database schema objects owner.  Used for user synonym and DB Link creation.';
...
create package body applications_pop
is

-- Package Body Applications_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'APPLICATIONS_POP' as "Package Body:"
 from  user_errors
 where name = 'APPLICATIONS_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
/
select 'DOMAINS_POP' as "Package:"
 from  user_errors
 where name = 'DOMAINS_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body domains_pop
is

-- Package Body Domains_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'DOMAINS_POP' as "Package Body:"
 from  user_errors
 where name = 'DOMAINS_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
create package domain_values_pop
is

   -- Package Domain_Values_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
   --    
   --    Generated by DTGen (http://code.google.com/p/dtgen)
   ...
   function tab_to_col
      ...
      return col_type;
end domain_values_pop;
/
select 'DOMAIN_VALUES_POP' as "Package:"
 from  user_errors
 where name = 'DOMAIN_VALUES_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body domain_values_pop
is

-- Package Body Domain_Values_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'DOMAIN_VALUES_POP' as "Package Body:"
 from  user_errors
 where name = 'DOMAIN_VALUES_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
/
select 'TABLES_POP' as "Package:"
 from  user_errors
 where name = 'TABLES_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
comment on column tables.ts_onln_data is 'Name for the on-line data table space for this table';
comment on column tables.ts_onln_indx is 'Name for the on-line index table space for this table';
comment on column tables.ts_hist_data is 'Name for the history data table space for this table';
comment on column tables.ts_hist_indx is 'Name for the history index table space for this table';
...
create package body tables_pop
is

-- Package Body Tables_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'TABLES_POP' as "Package Body:"
 from  user_errors
 where name = 'TABLES_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
create package tab_cols_pop
is

   -- Package Tab_Cols_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
   --    
   --    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'TAB_COLS_POP' as "Package:"
 from  user_errors
 where name = 'TAB_COLS_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body tab_cols_pop
is

-- Package Body Tab_Cols_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
--    March     30, 2012  09:06:54 AM
...
/
select 'TAB_COLS_POP' as "Package Body:"
 from  user_errors
 where name = 'TAB_COLS_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
/
select 'INDEXES_POP' as "Package:"
 from  user_errors
 where name = 'INDEXES_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body indexes_pop
is

-- Package Body Indexes_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'INDEXES_POP' as "Package Body:"
 from  user_errors
 where name = 'INDEXES_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
create package check_cons_pop
is

   -- Package Check_Cons_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
   --    
   --    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'CHECK_CONS_POP' as "Package:"
 from  user_errors
 where name = 'CHECK_CONS_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body check_cons_pop
is

-- Package Body Check_Cons_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'CHECK_CONS_POP' as "Package Body:"
 from  user_errors
 where name = 'CHECK_CONS_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
create package programs_pop
is

   -- Package Programs_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
   --    
   --    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'PROGRAMS_POP' as "Package:"
 from  user_errors
 where name = 'PROGRAMS_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body programs_pop
is

-- Package Body Programs_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'PROGRAMS_POP' as "Package Body:"
 from  user_errors
 where name = 'PROGRAMS_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
create package exceptions_pop
is

   -- Package Exceptions_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
   --    
   --    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'EXCEPTIONS_POP' as "Package:"
 from  user_errors
 where name = 'EXCEPTIONS_POP'
  and  type = 'PACKAGE'
  and  rownum = 1;
select '('||line||'/'||position||') '||text as error
 from  user_errors
...
create package body exceptions_pop
is

-- Package Body Exceptions_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
--    
--    Generated by DTGen (http://code.google.com/p/dtgen)
...
/
select 'EXCEPTIONS_POP' as "Package Body:"
 from  user_errors
 where name = 'EXCEPTIONS_POP'
  and  type = 'PACKAGE BODY'
  and  rownum = 1;
...
alter table applications add constraint applications_nn1
   check (abbr is not null);
alter table applications add constraint applications_nn2
   check (name is not null);
alter table applications add constraint applications_ck1
   check (instr(db_schema,' ') = 0 or db_schema is null);
alter table applications add constraint applications_ck2
   check (instr(apex_schema,' ') = 0 or apex_schema is null);
alter table applications add constraint applications_ck3
   check (instr(dbid,' ') = 0 or dbid is null);
...
CREATE TRIGGER applications_bd
   ...
   ON applications FOR EACH ROW
declare
   x_eff_end_dtm  timestamp(9) with local time zone;
begin
...
begin
   ...
   then
      ...
      if dbid != upper(dbid)
      then
         raise_application_error(-20003, 'applications_tab.check_rec(): dbid must be upper case.');
      end if;
   end if;
   --  Check for NOT NULL
   if abbr is null
...
alter table files add constraint files_nn1
   check (application_id is not null);
alter table files add constraint files_nn2
   check (name is not null);
alter table files add constraint files_nn3
...
alter table file_lines add constraint file_lines_nn1
   check (file_id is not null);
alter table file_lines add constraint file_lines_nn2
...
alter table domains add constraint domains_nn1
   check (application_id is not null);
alter table domains add constraint domains_nn2
   check (abbr is not null);
alter table domains add constraint domains_nn3
   check (name is not null);
alter table domains add constraint domains_nn4
   check (fold is not null);
alter table domains add constraint domains_nn5
   check (len is not null);
...
alter table domain_values add constraint domain_values_nn1
   check (domain_id is not null);
alter table domain_values add constraint domain_values_nn3
   check (seq is not null);
alter table domain_values add constraint domain_values_nn4
...
alter table tables add constraint tables_nn1
   check (application_id is not null);
alter table tables add constraint tables_nn2
   check (abbr is not null);
alter table tables add constraint tables_nn3
   check (name is not null);
alter table tables add constraint tables_nn4
   check (seq is not null);
alter table tables add constraint tables_nn5
   check (type is not null);
...
alter table tab_cols add constraint tab_cols_nn1
   check (table_id is not null);
alter table tab_cols add constraint tab_cols_nn2
   check (name is not null);
alter table tab_cols add constraint tab_cols_nn3
   check (seq is not null);
...
alter table indexes add constraint indexes_nn1
   check (tab_col_id is not null);
alter table indexes add constraint indexes_nn2
   check (tag is not null);
alter table indexes add constraint indexes_nn3
   check (seq is not null);
...
alter table check_cons add constraint check_cons_nn1
   check (table_id is not null);
alter table check_cons add constraint check_cons_nn2
   check (seq is not null);
alter table check_cons add constraint check_cons_nn3
...
alter table programs add constraint programs_nn1
   check (application_id is not null);
alter table programs add constraint programs_nn2
   check (name is not null);
alter table programs add constraint programs_nn3
   check (type is not null);
...
alter table exceptions add constraint exceptions_nn1
   check (application_id is not null);
alter table exceptions add constraint exceptions_nn2
   check (code is not null);
alter table exceptions add constraint exceptions_nn3
   check (name is not null);
...
comment on column applications_act.id is 'Surrogate Primary Key for this table';
...
comment on column applications_act.db_schema is 'Name of the database schema objects owner.  Used for user synonym and DB Link creation.';
...
comment on column files_act.id is 'Surrogate Primary Key for this table';
...
alter view files_act add constraint files_act_fk1
   foreign key (application_id) references applications (id) disable;
...
comment on column file_lines_act.id is 'Surrogate Primary Key for this table';
...
alter view file_lines_act add constraint file_lines_act_fk1
   foreign key (file_id) references files (id) disable;
...
comment on column domains_act.id is 'Surrogate Primary Key for this table';
...
comment on column domain_values_act.id is 'Surrogate Primary Key for this table';
...
alter view domain_values_act add constraint domain_values_act_fk1
   foreign key (domain_id) references domains (id) disable;
...
comment on column tables_act.id is 'Surrogate Primary Key for this table';
...
comment on column tables_act.ts_onln_data is 'Name for the on-line data table space for this table';
comment on column tables_act.ts_onln_indx is 'Name for the on-line index table space for this table';
comment on column tables_act.ts_hist_data is 'Name for the history data table space for this table';
comment on column tables_act.ts_hist_indx is 'Name for the history index table space for this table';
...
comment on column tab_cols_act.id is 'Surrogate Primary Key for this table';
...
alter view tab_cols_act add constraint tab_cols_act_fk1
   foreign key (table_id) references tables (id) disable;
alter view tab_cols_act add constraint tab_cols_act_fk2
   foreign key (fk_table_id) references tables (id) disable;
alter view tab_cols_act add constraint tab_cols_act_fk3
   foreign key (d_domain_id) references domains (id) disable;
...
comment on column indexes_act.id is 'Surrogate Primary Key for this table';
...
alter view indexes_act add constraint indexes_act_fk1
   foreign key (tab_col_id) references tab_cols (id) disable;
...
comment on column check_cons_act.id is 'Surrogate Primary Key for this table';
...
comment on column programs_act.id is 'Surrogate Primary Key for this table';
...
comment on column exceptions_act.id is 'Surrogate Primary Key for this table';
