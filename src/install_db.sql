...
--
--  Install install_db Scripts for DTGEN
--
...
--   EXECUTE IMMEDIATE 'delete from programs';
--   EXECUTE IMMEDIATE 'delete from check_cons';
--   EXECUTE IMMEDIATE 'delete from tab_inds';
--   EXECUTE IMMEDIATE 'delete from tab_cols';
--   EXECUTE IMMEDIATE 'delete from tables';
--   EXECUTE IMMEDIATE 'delete from domain_values';
--   EXECUTE IMMEDIATE 'delete from domains';
--   EXECUTE IMMEDIATE 'delete from file_lines';
--   EXECUTE IMMEDIATE 'delete from file_lines_AUD';
--   EXECUTE IMMEDIATE 'delete from file_lines_PDAT';
--   EXECUTE IMMEDIATE 'delete from files';
--   EXECUTE IMMEDIATE 'delete from files_AUD';
--   EXECUTE IMMEDIATE 'delete from files_PDAT';
--   EXECUTE IMMEDIATE 'delete from applications';
...
create table applications
   ...
   LOB (copyright) STORE AS BASICFILE applications_CL18
       (CACHE LOGGING)
/
...
/
comment on column applications.version is 'Version of this application'
/
...
/
comment on column applications.dbid is 'Database link name for mid-tier connections from mid-tier servers to the centralized database server'
/
comment on column applications.db_auth is 'Centralized database server schema name pointed to by the database link from the mid-tier servers'
/
...
begin
   ...
   then
      ...
      if version != initcap(version)
      then
         raise_application_error(-20003, 'applications_tab.check_rec(): version must be initial case.');
      end if;
...
begin
   if     o_abbr = n_abbr
      and o_name = n_name
      and util.is_equal(o_version, n_version)
...
/
select 'FILES_POP' as "Package:"
 from  user_errors
 where name  = 'FILES_POP'
  and  type  = 'PACKAGE'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure ins
      ...
      ,n_description  in out  VARCHAR2
      ,n_aud_beg_usr  out  VARCHAR2
      ,n_aud_beg_dtm  out  timestamp with local time zone
      );
   procedure upd
      (o_id  in  NUMBER
      ...
      ,o_description  in  VARCHAR2
      ,n_description  in out  VARCHAR2
      ,o_aud_beg_usr  in   VARCHAR2
      ,n_aud_beg_usr  out  VARCHAR2
      ,o_aud_beg_dtm  in   timestamp with local time zone
      ,n_aud_beg_dtm  out  timestamp with local time zone
      );
   procedure del
      (o_id  in  NUMBER
...
create table files
   (id   NUMBER(38)
   ,aud_beg_usr   varchar2(30)
         constraint files_nnh3 not null
   ,aud_beg_dtm   timestamp(9) with local time zone
         constraint files_nnh5 not null
...
/
comment on column files.aud_beg_usr is 'User that created this record'
/
comment on column files.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
...
/
comment on column files.created_dt is 'Time/Date this file was created/updated'
/
...
create table files_AUD
   (files_id   NUMBER(38)
   ,aud_beg_usr   varchar2(30)
         constraint files_AUD_nnh3 not null
   ,aud_end_usr   varchar2(30)
         constraint files_AUD_nnh4 not null
   ,aud_beg_dtm   timestamp(9) with local time zone
         constraint files_AUD_nnh5 not null
   ,aud_end_dtm   timestamp(9) with local time zone
         constraint files_AUD_nnh6 not null
   ,application_id   NUMBER(38)
   ,name   VARCHAR2(30)
   ,type   VARCHAR2(3)
   ,created_dt   DATE
   ,description   VARCHAR2(1000)
   ,last_active  varchar2(1)
   ) pctfree 1
/

comment on table files_AUD is 'Files for capturing scripts and logs (history)'
/

comment on column files_AUD.files_id is 'Surrogate Primary Key from the ACTIVE table'
/
comment on column files_AUD.aud_end_usr is 'User that modified this record'
/
comment on column files_AUD.aud_end_dtm is 'Date/Time this record was modified (must be in nanoseconds)'
/
comment on column files_AUD.aud_beg_usr is 'User that created this record'
/
comment on column files_AUD.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
comment on column files_AUD.application_id is 'Surrogate Key for the application of this file'
/
comment on column files_AUD.name is 'Name of this file'
/
comment on column files_AUD.type is 'Type for this file'
/
comment on column files_AUD.created_dt is 'Time/Date this file was created/updated'
/
comment on column files_AUD.description is 'Description for this file'
/
comment on column files_AUD.last_active is 'Flag to indicate this as the last active record'
/

create trigger files_AUD_bu
   before update on files_AUD
   for each row
begin

   -- Trigger Files_Aud_Bu

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_AUD_bu');
   raise_application_error(-20001,
      'files_AUD_bu:update is not allowed on this table.');

end files_AUD_bu;
/
select 'FILES_AUD_BU' as "Trigger:"
 from  user_errors
 where name  = 'FILES_AUD_BU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create table files_PDAT
   (files_id       NUMBER(38)
   ,pop_dml              varchar2(6)
         constraint files_PDAT_nnp1 not null
   ,pop_dtm              timestamp(9)
         constraint files_PDAT_nnp2 not null
   ,pop_usr              varchar2(30)
         constraint files_PDAT_nnp3 not null
   ,aud_beg_usr          varchar2(30)
         constraint files_PDAT_nnh3 not null
   ,aud_prev_beg_usr     varchar2(30)
   ,aud_beg_dtm          timestamp(9) with local time zone
         constraint files_PDAT_nnh5 not null
   ,aud_prev_beg_dtm     timestamp(9) with local time zone
   ,application_id     NUMBER(38)
   ,name     VARCHAR2(30)
   ,type     VARCHAR2(3)
   ,created_dt     DATE
...
comment on table files_PDAT is 'Files for capturing scripts and logs (POP function audit log)'
/

comment on column files_PDAT.files_id is 'Surrogate Primary Key from the ACTIVE table'
/
comment on column files_PDAT.pop_dml is 'Original DML that was popped: INSERT, UPDATE, or DELETE'
/
comment on column files_PDAT.pop_dtm is 'Date/Time this record was popped'
/
comment on column files_PDAT.pop_usr is 'User that ran the POP'
/
comment on column files_PDAT.aud_beg_usr is 'User that modified this record before being POPed out of active'
/
comment on column files_PDAT.aud_prev_beg_usr is 'User that modified the previous record before being POPed back to active'
/
comment on column files_PDAT.aud_beg_dtm is 'Date/Time this record was modified before being POPed out of active'
/
comment on column files_PDAT.aud_prev_beg_dtm is 'Date/Time the previous record was modified before being POPed back to active'
/
comment on column files_PDAT.application_id is 'Surrogate Key for the application of this file'
/
comment on column files_PDAT.name is 'Name of this file'
/
comment on column files_PDAT.type is 'Type for this file'
/
comment on column files_PDAT.created_dt is 'Time/Date this file was created/updated'
/
comment on column files_PDAT.description is 'Description for this file'
/

create trigger files_PDAT_bu
   before update on files_PDAT
   for each row
begin

   -- Trigger Files_Pdat_Bu

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_PDAT_bu');
   raise_application_error(-20001,
      'files_PDAT_bu:update is not allowed on this table.');

end files_PDAT_bu;
/
select 'FILES_PDAT_BU' as "Trigger:"
 from  user_errors
 where name  = 'FILES_PDAT_BU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
/***  HISTORY Foreign Keys and Indexes  ***/
alter table files_AUD add constraint files_AUD_pk
   primary key (files_id
               ,aud_beg_dtm
               )
/
create index files_AUD_nk
   on files_AUD
           (application_id
           ,name
           ,aud_beg_dtm
...
/***  HISTORY Audit Foreign Key and Indexes  ***/
-- create index files_AUD_ia1 on files_AUD(aud_beg_usr, aud_beg_dtm)
-- /
-- create index files_AUD_ia2 on files_AUD(aud_beg_dtm)
-- /
-- create index files_AUD_ia3 on files_AUD(aud_end_usr, aud_beg_dtm)
-- /
-- create index files_AUD_ia4 on files_AUD(aud_end_dtm)
-- /

/***  POP Foreign Keys and Indexes  ***/
alter table files_PDAT add constraint files_PDAT_pk
   primary key (files_id
               ,aud_beg_dtm
               )
/
create index files_PDAT_nk
   on files_PDAT
           (application_id
           ,name
           ,aud_beg_dtm
...
/***  HISTORY Audit Foreign Key and Indexes  ***/
-- create index files_PDAT_ia1 on files_PDAT(aud_beg_usr, aud_beg_dtm)
-- /
-- create index files_PDAT_ia2 on files_PDAT(aud_beg_dtm)
-- /
-- create index files_PDAT_ia3 on files_PDAT(aud_prev_beg_usr, aud_beg_dtm)
-- /
-- create index files_PDAT_ia4 on files_PDAT(aud_prev_beg_dtm)
-- /

create package body files_pop
is

-- Package Body Files_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
...
function tab_to_col
   ...
   return col_type
is
   -- This function is duplicated in files_DML
   cursor acur is
      select * from files
       where id = id_in;
   abuf   acur%ROWTYPE;
...
is
   ...
   abuf   acur%ROWTYPE;
   cursor hcur is
      select * from files_AUD
       where files_id = id_in
       order by aud_end_dtm desc;
   hbuf   hcur%ROWTYPE;
   rcol      col_type;
   orig_dbc  boolean := null;
begin
   -- Turn off trigger checks and history records
   orig_dbc := glob.get_db_constraints;
   glob.set_db_constraints(FALSE);
   -- Check for a current record
   open acur;
   fetch acur into abuf;
   if acur%NOTFOUND
   then
      -- No current record found
      -- Check for any history/audit records
      open hcur;
      fetch hcur into hbuf;
      -- if hcur%NOTFOUND
      -- then
      --    -- There are no history/audit records
      --    ERROR: NOTHING TO POP
      -- end if
      if hcur%FOUND
      then
         -- Found history/audit records
         -- Add the History/Audit record to the pop_audit table
         insert into files_PDAT
               (files_id
               ,pop_dml
               ,pop_dtm
               ,pop_usr
            ...
            values
               ...
               ,hbuf.aud_end_dtm
               ,hbuf.aud_beg_dtm);
         -- Add the last history/audit record to the files table
         insert into files
               (id
               ,application_id
               ,name
         ...
         -- Delete the last history/audit record from the history/audit table
         delete from files_AUD
          where files_id = id_in
           and  aud_beg_dtm = hbuf.aud_beg_dtm;
      end if;
      close hcur;
   else
      -- Found a current record
      -- Build the ACTIVE record COL object
      rcol := tab_to_col(id_in);
      -- Check for any history/audit records
      open hcur;
      fetch hcur into hbuf;
      if hcur%NOTFOUND
      then
         -- No history/audit records found
         -- Add the Active record to the pop_audit table
         insert into files_PDAT
               (files_id
               ,pop_dml
               ,pop_dtm
         ...
         delete from  files
          where id = id_in;
         -- util.log('POPed insert of files record: ' ||
         --          substr(util.col_to_clob(rcol),1,32000));
      else
         -- Found history/audit records
         -- Add the Active and History/Audit record to the pop_audit table
         insert into files_PDAT
               (files_id
               ,pop_dml
               ,pop_dtm
            ...
            values
               -- Add History/Audit dates/users to pop_audit
               (abuf.id
               ,'UPDATE'
               ,glob.get_dtm
               ,glob.get_usr
         ...
         -- Update files table from the last history/audit record
         update files
           set  application_id = hbuf.application_id
               ,name = hbuf.name
               ,type = hbuf.type
               ,created_dt = hbuf.created_dt
               ,description = hbuf.description
               ,aud_beg_usr = hbuf.aud_beg_usr
               ,aud_beg_dtm = hbuf.aud_beg_dtm
          where id = hbuf.files_id;
         -- Delete the last history/audit record from the history/audit table
         delete from  files_AUD
          where files_id = id_in
           and  aud_beg_dtm = hbuf.aud_beg_dtm;
   ...
   close acur;
   -- Restore trigger checks and history records
   glob.set_db_constraints(orig_dbc);
exception
   when others then
      util.err(sqlerrm);
      if orig_dbc is not null then
         glob.set_db_constraints(orig_dbc);
      end if;
      raise;
end at_server;
...
/
select 'FILES_POP' as "Package Body:"
 from  user_errors
 where name  = 'FILES_POP'
  and  type  = 'PACKAGE BODY'
  and  rownum = 1
...
begin
   ...
   if created_dt is null
   then
      raise_application_error(-20004, 'files_tab.check_rec(): created_dt cannot be null.');
   end if;
   -- Check for Domain Values
...
begin
   ...
   n_aud_beg_usr := glob.get_usr;
   n_aud_beg_dtm := glob.get_dtm;
end ins;
----------------------------------------
procedure upd
      (o_id  in  NUMBER
...
begin
   if     o_application_id = n_application_id
      and o_name = n_name
      and o_type = n_type
      and o_created_dt = n_created_dt
      and util.is_equal(o_description, n_description)
   then
      if glob.get_ignore_no_change
      then
         n_aud_beg_usr := o_aud_beg_usr;
         n_aud_beg_dtm := o_aud_beg_dtm;
         return;
      end if;
   ...
   n_aud_beg_usr := glob.get_usr;
   n_aud_beg_dtm := glob.get_dtm;
   if n_aud_beg_dtm <= o_aud_beg_dtm
   then
      raise_application_error(-20009, 'files_tab.upd(): The New Audit Date must be greater than ' || o_aud_beg_dtm);
   end if;
   insert into files_AUD
         (files_id
         ,application_id
         ,name
         ,type
...
is
   n_aud_beg_usr  varchar2(30);
   n_aud_beg_dtm  timestamp(9) with local time zone;
begin
   n_aud_beg_usr := glob.get_usr;
   n_aud_beg_dtm := glob.get_dtm;
   if n_aud_beg_dtm <= o_aud_beg_dtm
   then
      raise_application_error(-20009, 'files_tab.del(): The New Audit Date must be greater than ' || o_aud_beg_dtm);
   end if;
   insert into files_AUD
         (files_id
         ,application_id
...
create package file_lines_pop
is

   -- Package File_Lines_Pop
   --    Pop (UNDO) functions
   --    (Centrally located, but globally visible)
...
/
select 'FILE_LINES_POP' as "Package:"
 from  user_errors
 where name  = 'FILE_LINES_POP'
  and  type  = 'PACKAGE'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create table file_lines
   (id   NUMBER(38)
   ,aud_beg_usr   varchar2(30)
         constraint file_lines_nnh3 not null
   ,aud_beg_dtm   timestamp(9) with local time zone
         constraint file_lines_nnh5 not null
   ,file_id   NUMBER(38)
...
/
comment on column file_lines.aud_beg_usr is 'User that created this record'
/
comment on column file_lines.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
...
create table file_lines_AUD
   (file_lines_id   NUMBER(38)
   ,aud_beg_usr   varchar2(30)
         constraint file_lines_AUD_nnh3 not null
   ,aud_end_usr   varchar2(30)
         constraint file_lines_AUD_nnh4 not null
   ,aud_beg_dtm   timestamp(9) with local time zone
         constraint file_lines_AUD_nnh5 not null
   ,aud_end_dtm   timestamp(9) with local time zone
         constraint file_lines_AUD_nnh6 not null
   ,file_id   NUMBER(38)
   ,seq   NUMBER(9)
   ,value   VARCHAR2(1000)
   ,last_active  varchar2(1)
...
comment on table file_lines_AUD is 'Lines for files (history)'
/

comment on column file_lines_AUD.file_lines_id is 'Surrogate Primary Key from the ACTIVE table'
/
comment on column file_lines_AUD.aud_end_usr is 'User that modified this record'
/
comment on column file_lines_AUD.aud_end_dtm is 'Date/Time this record was modified (must be in nanoseconds)'
/
comment on column file_lines_AUD.aud_beg_usr is 'User that created this record'
/
comment on column file_lines_AUD.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
comment on column file_lines_AUD.file_id is 'Surrogate Key for the file of this line'
/
comment on column file_lines_AUD.seq is 'Sequence number for this line in the file'
/
comment on column file_lines_AUD.value is 'Value or contents of this line in the file'
/
comment on column file_lines_AUD.last_active is 'Flag to indicate this as the last active record'
/

create trigger file_lines_AUD_bu
   before update on file_lines_AUD
   for each row
begin

   -- Trigger File_Lines_Aud_Bu

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_AUD_bu');
   raise_application_error(-20001,
      'file_lines_AUD_bu:update is not allowed on this table.');

end file_lines_AUD_bu;
/
select 'FILE_LINES_AUD_BU' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_AUD_BU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create table file_lines_PDAT
   (file_lines_id       NUMBER(38)
   ,pop_dml              varchar2(6)
         constraint file_lines_PDAT_nnp1 not null
   ,pop_dtm              timestamp(9)
         constraint file_lines_PDAT_nnp2 not null
   ,pop_usr              varchar2(30)
         constraint file_lines_PDAT_nnp3 not null
   ,aud_beg_usr          varchar2(30)
         constraint file_lines_PDAT_nnh3 not null
   ,aud_prev_beg_usr     varchar2(30)
   ,aud_beg_dtm          timestamp(9) with local time zone
         constraint file_lines_PDAT_nnh5 not null
   ,aud_prev_beg_dtm     timestamp(9) with local time zone
   ,file_id     NUMBER(38)
   ,seq     NUMBER(9)
   ,value     VARCHAR2(1000)
...
comment on table file_lines_PDAT is 'Lines for files (POP function audit log)'
/

comment on column file_lines_PDAT.file_lines_id is 'Surrogate Primary Key from the ACTIVE table'
/
comment on column file_lines_PDAT.pop_dml is 'Original DML that was popped: INSERT, UPDATE, or DELETE'
/
comment on column file_lines_PDAT.pop_dtm is 'Date/Time this record was popped'
/
comment on column file_lines_PDAT.pop_usr is 'User that ran the POP'
/
comment on column file_lines_PDAT.aud_beg_usr is 'User that modified this record before being POPed out of active'
/
comment on column file_lines_PDAT.aud_prev_beg_usr is 'User that modified the previous record before being POPed back to active'
/
comment on column file_lines_PDAT.aud_beg_dtm is 'Date/Time this record was modified before being POPed out of active'
/
comment on column file_lines_PDAT.aud_prev_beg_dtm is 'Date/Time the previous record was modified before being POPed back to active'
/
comment on column file_lines_PDAT.file_id is 'Surrogate Key for the file of this line'
/
comment on column file_lines_PDAT.seq is 'Sequence number for this line in the file'
/
comment on column file_lines_PDAT.value is 'Value or contents of this line in the file'
/

create trigger file_lines_PDAT_bu
   before update on file_lines_PDAT
   for each row
begin

   -- Trigger File_Lines_Pdat_Bu

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_PDAT_bu');
   raise_application_error(-20001,
      'file_lines_PDAT_bu:update is not allowed on this table.');

end file_lines_PDAT_bu;
/
select 'FILE_LINES_PDAT_BU' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_PDAT_BU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
/***  HISTORY Foreign Keys and Indexes  ***/
alter table file_lines_AUD add constraint file_lines_AUD_pk
   primary key (file_lines_id
               ,aud_beg_dtm
               )
/
create index file_lines_AUD_nk
   on file_lines_AUD
           (file_id
           ,seq
           ,aud_beg_dtm
...
/
create index file_lines_AUD_fx1
   on file_lines_AUD
           (file_id
           ,aud_beg_dtm
           )
...
/***  HISTORY Audit Foreign Key and Indexes  ***/
-- create index file_lines_AUD_ia1 on file_lines_AUD(aud_beg_usr, aud_beg_dtm)
-- /
-- create index file_lines_AUD_ia2 on file_lines_AUD(aud_beg_dtm)
-- /
-- create index file_lines_AUD_ia3 on file_lines_AUD(aud_end_usr, aud_beg_dtm)
-- /
-- create index file_lines_AUD_ia4 on file_lines_AUD(aud_end_dtm)
-- /

/***  POP Foreign Keys and Indexes  ***/
alter table file_lines_PDAT add constraint file_lines_PDAT_pk
   primary key (file_lines_id
               ,aud_beg_dtm
               )
/
create index file_lines_PDAT_nk
   on file_lines_PDAT
           (file_id
           ,seq
           ,aud_beg_dtm
...
/
create index file_lines_PDAT_fx1
   on file_lines_PDAT
           (file_id
           ,aud_beg_dtm
           )
...
/***  HISTORY Audit Foreign Key and Indexes  ***/
-- create index file_lines_PDAT_ia1 on file_lines_PDAT(aud_beg_usr, aud_beg_dtm)
-- /
-- create index file_lines_PDAT_ia2 on file_lines_PDAT(aud_beg_dtm)
-- /
-- create index file_lines_PDAT_ia3 on file_lines_PDAT(aud_prev_beg_usr, aud_beg_dtm)
-- /
-- create index file_lines_PDAT_ia4 on file_lines_PDAT(aud_prev_beg_dtm)
-- /

create package body file_lines_pop
is

-- Package Body File_Lines_Pop
--    Pop (UNDO) functions
--    (Centrally located, but globally visible)
...
function tab_to_col
   ...
   return col_type
is
   -- This function is duplicated in file_lines_DML
   cursor acur is
...
is
   ...
   abuf   acur%ROWTYPE;
   cursor hcur is
      select * from file_lines_AUD
       where file_lines_id = id_in
       order by aud_end_dtm desc;
   hbuf   hcur%ROWTYPE;
   rcol      col_type;
   orig_dbc  boolean := null;
   ...
   then
      ...
      then
         ...
         insert into file_lines_PDAT
            ...
            values
               ...
               ,hbuf.aud_end_dtm
               ,hbuf.aud_beg_dtm);
         -- Add the last history/audit record to the file_lines table
      ...
      then
         ...
         delete from  file_lines
          where id = id_in;
         -- util.log('POPed insert of file_lines record: ' ||
         --          substr(util.col_to_clob(rcol),1,32000));
      else
         -- Found history/audit records
         -- Add the Active and History/Audit record to the pop_audit table
         ...
         -- Update file_lines table from the last history/audit record
         update file_lines
           set  file_id = hbuf.file_id
               ,seq = hbuf.seq
               ,value = hbuf.value
               ,aud_beg_usr = hbuf.aud_beg_usr
               ,aud_beg_dtm = hbuf.aud_beg_dtm
          where id = hbuf.file_lines_id;
         -- Delete the last history/audit record from the history/audit table
         delete from  file_lines_AUD
          where file_lines_id = id_in
           and  aud_beg_dtm = hbuf.aud_beg_dtm;
...
/
select 'FILE_LINES_POP' as "Package Body:"
 from  user_errors
 where name  = 'FILE_LINES_POP'
  and  type  = 'PACKAGE BODY'
  and  rownum = 1
...
begin
   ...
   if n_aud_beg_dtm <= o_aud_beg_dtm
   then
      raise_application_error(-20009, 'file_lines_tab.upd(): The New Audit Date must be greater than ' || o_aud_beg_dtm);
   end if;
   insert into file_lines_AUD
         (file_lines_id
         ,file_id
         ,seq
         ,value
...
begin
   ...
   if n_aud_beg_dtm <= o_aud_beg_dtm
   then
      raise_application_error(-20009, 'file_lines_tab.del(): The New Audit Date must be greater than ' || o_aud_beg_dtm);
   end if;
   insert into file_lines_AUD
         (file_lines_id
         ,file_id
...
create table domain_values
   ...
   ,value   VARCHAR2(100)
         constraint domain_values_nn2 not null
   ,seq   NUMBER(2)
...
begin
   ...
   if not (seq < 200)
   then
      raise_application_error(-20006, 'tables_tab.check_rec(): Table sequence number must be less than 200 because of the PNUMÂ offsets in the generator package');
   end if;
...
create package tab_inds_tab
is

   -- Package Tab_Inds_Tab
   --    Table functions
   --    (DML and integrity checks)
   --
...
/
select 'TAB_INDS_TAB' as "Package:"
 from  user_errors
 where name  = 'TAB_INDS_TAB'
  and  type  = 'PACKAGE'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create sequence tab_inds_seq
/

create table tab_inds
   (id   NUMBER(38)
   ,tab_col_id   NUMBER(38)
         constraint tab_inds_nn1 not null
   ,tag   VARCHAR2(4)
         constraint tab_inds_nn2 not null
   ,seq   NUMBER(1)
         constraint tab_inds_nn3 not null
   ) pctfree 3
/

comment on table tab_inds is 'Unique and non-unique indexes for this table'
/

comment on column tab_inds.id is 'Surrogate Primary Key for these tab_inds'
/
comment on column tab_inds.tab_col_id is 'Surrogate Key for the column for this index'
/
comment on column tab_inds.tag is 'Tag attached to the table name for this column that uniquely identifies this index'
/
comment on column tab_inds.seq is 'Sequence number for this column for this index'
/

alter table tab_inds add constraint tab_inds_pk
   primary key (id)
/

/***  ACTIVE Foreign Keys  ***/
alter table tab_inds add constraint tab_inds_fk1
   foreign key (tab_col_id) references tab_cols (id)
/

/***  ACTIVE Indexes  ***/
alter table tab_inds add constraint tab_inds_nk
    unique (tab_col_id
           ,tag
           ,seq
           )
/
create index tab_inds_fx1 on tab_inds(tab_col_id)
/


/***  ACTIVE Audit Foreign Key Indexes  ***/
-- create index tab_inds_ia1 on tab_inds(aud_beg_usr)
-- /
-- create index tab_inds_ia2 on tab_inds(aud_beg_dtm)
-- /

create package body tab_inds_tab
is

-- Package Body Tab_Inds_Tab
--    Table functions
--    (DML and integrity checks)
...
begin
   ...
   then
      ...
      if tag != lower(tag)
      then
         raise_application_error(-20003, 'tab_inds_tab.check_rec(): tag must be lower case.');
      end if;
   end if;
   --  Check for NOT NULL
   if tab_col_id is null
   then
      raise_application_error(-20004, 'tab_inds_tab.check_rec(): tab_col_id cannot be null.');
   end if;
   if tag is null
   then
      raise_application_error(-20004, 'tab_inds_tab.check_rec(): tag cannot be null.');
   end if;
   if seq is null
   then
      raise_application_error(-20004, 'tab_inds_tab.check_rec(): seq cannot be null.');
   end if;
   -- Check for Domain Values
   -- Custom Constraint Checks
   if not (seq > 0)
   then
      raise_application_error(-20006, 'tab_inds_tab.check_rec(): Index column sequence must be greater than 0');
   end if;
   --  Set eff_beg_dtm, if needed
end check_rec;
----------------------------------------
...
begin
   ...
   then
      ...
      raise_application_error(-20008, 'tab_inds_tab.upd(): Must update one of'
            || ' tab_col_id'
            || ', tag'
            || ', seq'
            || '.');
...
/
select 'TAB_INDS_TAB' as "Package Body:"
 from  user_errors
 where name  = 'TAB_INDS_TAB'
  and  type  = 'PACKAGE BODY'
  and  rownum = 1
...
begin
   ...
   -- Check for Domain Values
   if type not in ('PACKAGE', 'FUNCTION', 'PROCEDURE', 'VIEW')
   then
      raise_application_error(-20005, 'programs_tab.check_rec(): type must be one of ("PACKAGE", "FUNCTION", "PROCEDURE", "VIEW").');
   end if;
   -- Custom Constraint Checks
   if not (instr(name,' ') = 0)
   then
...
/
alter table applications add constraint applications_fld12
   check (ts_onln_data = lower(ts_onln_data))
/
alter table applications add constraint applications_fld13
   check (ts_onln_indx = lower(ts_onln_indx))
/
alter table applications add constraint applications_fld14
   check (ts_hist_data = lower(ts_hist_data))
/
alter table applications add constraint applications_fld15
   check (ts_hist_indx = lower(ts_hist_indx))
/
alter table applications add constraint applications_fld16
   check (usr_datatype = upper(usr_datatype))
/
alter table applications add constraint applications_fld17
   check (usr_frgn_key = lower(usr_frgn_key))
/
alter table applications add constraint applications_dm11
...
alter table files add constraint files_dm3
   check (type in ('SQL', 'LOG'))
/

alter table files_AUD add constraint files_AUD_au1
      check (aud_beg_dtm < aud_end_dtm)
/
alter table files_AUD add constraint files_AUD_la1
      check (last_active = 'Y')
/

-- alter table files_PDAT add constraint files_PDAT_au1
--       check (aud_beg_dtm < aud_prev_beg_dtm)
-- /
-- alter table files_PDAT add constraint files_PDAT_la1
--       check (last_active = 'Y')
-- /
...
alter table file_lines_AUD add constraint file_lines_AUD_au1
      check (aud_beg_dtm < aud_end_dtm)
/
alter table file_lines_AUD add constraint file_lines_AUD_la1
      check (last_active = 'Y')
/

-- alter table file_lines_PDAT add constraint file_lines_PDAT_au1
--       check (aud_beg_dtm < aud_prev_beg_dtm)
-- /
-- alter table file_lines_PDAT add constraint file_lines_PDAT_la1
--       check (last_active = 'Y')
-- /
...
alter table domains add constraint domains_fld2
   check (abbr = upper(abbr))
/
alter table domains add constraint domains_fld3
   check (name = initcap(name))
/
alter table domains add constraint domains_dm4
   check (fold in ('U', 'L', 'I'))
/
...
/
alter table tables add constraint tables_fld8
   check (ts_onln_data = lower(ts_onln_data))
/
alter table tables add constraint tables_fld9
   check (ts_onln_indx = lower(ts_onln_indx))
/
alter table tables add constraint tables_fld10
   check (ts_hist_data = lower(ts_hist_data))
/
alter table tables add constraint tables_fld11
   check (ts_hist_indx = lower(ts_hist_indx))
/
alter table tables add constraint tables_dm5
...
alter table tab_cols add constraint tab_cols_fld2
   check (name = lower(name))
/
alter table tab_cols add constraint tab_cols_fld6
   check (fk_prefix = lower(fk_prefix))
/
alter table tab_cols add constraint tab_cols_dm5
   check (req in ('X'))
/
alter table tab_cols add constraint tab_cols_dm9
   check (type in ('NUMBER', 'VARCHAR2', 'DATE', 'TIMESTAMP WITH TIME ZONE', 'TIMESTAMP WITH LOCAL TIME ZONE'))
/
alter table tab_cols add constraint tab_cols_dm12
   check (fold in ('U', 'L', 'I'))
/
...
alter table tab_inds add constraint tab_inds_ck1
   check (seq > 0)
/
alter table tab_inds add constraint tab_inds_fld2
   check (tag = lower(tag))
/

CREATE TRIGGER tab_inds_bi
   BEFORE INSERT
   ON tab_inds FOR EACH ROW
begin
...
/
select 'TAB_INDS_BI' as "Trigger:"
 from  user_errors
 where name  = 'TAB_INDS_BI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
/
select 'TAB_INDS_BU' as "Trigger:"
 from  user_errors
 where name  = 'TAB_INDS_BU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
/
select 'TAB_INDS_BD' as "Trigger:"
 from  user_errors
 where name  = 'TAB_INDS_BD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
alter table programs add constraint programs_ck1
   check (instr(name,' ') = 0)
/
alter table programs add constraint programs_fld2
   check (name = lower(name))
/
alter table programs add constraint programs_dm3
   check (type in ('PACKAGE', 'FUNCTION', 'PROCEDURE', 'VIEW'))
/
...
alter table exceptions add constraint exceptions_ck2
   check (instr(name,' ') = 0)
/
alter table exceptions add constraint exceptions_fld3
   check (name = lower(name))
/
...
/
comment on column applications_act.version is 'Version of this application'
/
...
/
comment on column applications_act.dbid is 'Database link name for mid-tier connections from mid-tier servers to the centralized database server'
/
comment on column applications_act.db_auth is 'Centralized database server schema name pointed to by the database link from the mid-tier servers'
/
...
create TRIGGER applications_act_ioi
...
declare
   ...
   n_copyright  VARCHAR2(32767);
begin

   -- Trigger Applications_Act_Ioi
...
end applications_act_ioi;
/
select 'APPLICATIONS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'APPLICATIONS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER applications_act_iou
...
end applications_act_iou;
/
select 'APPLICATIONS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'APPLICATIONS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER applications_act_iod
   instead of delete on applications_act
   for each row
begin

   -- Trigger Applications_Act_Iod
...
end applications_act_iod;
/
select 'APPLICATIONS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'APPLICATIONS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  applications_ACT%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if applications_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
         ,abbr
...
is
   junk  varchar2(1);  -- A DTGen generator short-cut
begin
   if util.db_object_exists('APPLICATIONS', 'MATERIALIZED VIEW')
   then
   ...
   update applications APP
    ...
    where APP.id = o_id;
   -- Set RETURNING VALUES if applications_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
         ,abbr
...
begin
   ...
   rcol := COL_TYPE
             ...
             ,PAIR_TYPE('name', abuf.name)
             ,PAIR_TYPE('version', abuf.version)
...
begin
   ...
   n_buff.name := null;
   n_buff.version := null;
   n_buff.db_schema := null;
   n_buff.apex_schema := null;
   n_buff.apex_ws_name := null;
   n_buff.apex_app_name := null;
   n_buff.dbid := null;
   n_buff.db_auth := null;
   n_buff.description := null;
   n_buff.ts_null_override := null;
   n_buff.ts_onln_data := null;
   n_buff.ts_onln_indx := null;
   n_buff.ts_hist_data := null;
   n_buff.ts_hist_indx := null;
   n_buff.usr_datatype := null;
   n_buff.usr_frgn_key := null;
   n_buff.copyright := null;
end clear;
----------------------------------------
procedure ins
      (n_id  in out  NUMBER
...
begin
   applications_dml.ins
      ...
      ,n_buff.apex_schema
      ,n_buff.apex_ws_name
      ,n_buff.apex_app_name
      ,n_buff.dbid
      ,n_buff.db_auth
      ,n_buff.description
      ,n_buff.ts_null_override
      ,n_buff.ts_onln_data
      ,n_buff.ts_onln_indx
      ,n_buff.ts_hist_data
      ,n_buff.ts_hist_indx
...
create view files_act
   ...
   as select
      ...
      ,F.aud_beg_dtm
 from             files F
       inner join applications_act APP on APP.id = F.application_id
/
...
/
comment on column files_act.aud_beg_usr is 'User that created this record'
/
comment on column files_act.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
...
/
comment on column files_act.created_dt is 'Time/Date this file was created/updated'
/
...
/
select 'FILES_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
/
select 'FILES_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER files_act_iod
   instead of delete on files_act
   for each row
begin

   -- Trigger Files_Act_Iod
...
/
select 'FILES_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  files_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  files%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if files_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
      ...
      into n_id
       ...
       where (    n_id is not null
              and n_id = id       )
        or   (    n_application_id is not null
              and n_application_id = application_id
...
procedure upd
      ...
      ,o_description  in  VARCHAR2
      ,n_description  in out  VARCHAR2
      ,o_aud_beg_usr  VARCHAR2
      ,o_aud_beg_dtm  timestamp with local time zone
      )
   -- View Update procedure
is
   n_aud_beg_usr  varchar2(30);
...
begin
   ...
   update files F
     set  F.application_id = n_application_id
         ...
         ,F.aud_beg_dtm = n_aud_beg_dtm
         ,F.aud_beg_usr = n_aud_beg_usr
    where F.id = o_id;
   -- Set RETURNING VALUES if files_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
begin
   n_buff.id := null;
   n_buff.application_id := null;
   n_buff.applications_nk1 := null;
   n_buff.name := null;
   n_buff.type := null;
   n_buff.created_dt := null;
   n_buff.description := null;
end clear;
----------------------------------------
procedure clear
...
begin
   files_dml.ins
      (n_buff.id
      ,n_buff.application_id
      ,n_buff.applications_nk1
      ,n_buff.name
      ,n_buff.type
      ,n_buff.created_dt
      ,n_buff.description
...
begin
   files_dml.ins
      (n_id => n_buff.id
      ,n_application_id => n_buff.application_id
      ,n_name => n_buff.name
      ,n_type => n_buff.type
      ,n_created_dt => n_buff.created_dt
      ,n_description => n_buff.description
      );
end ins;
----------------------------------------
procedure upd
...
is
   ...
   o_created_dt  DATE;
   o_description  VARCHAR2(1000);
   o_aud_beg_usr  varchar2(30);
   o_aud_beg_dtm  timestamp(9) with local time zone;
begin
   -- Retrieve the old (before update) data
...
create view file_lines_act
   ...
   as select
      ...
      ,FL.aud_beg_dtm
 from             file_lines FL
       inner join files_act F on F.id = FL.file_id
/
...
/
comment on column file_lines_act.aud_beg_usr is 'User that created this record'
/
comment on column file_lines_act.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
...
create TRIGGER file_lines_act_ioi
...
end file_lines_act_ioi;
/
select 'FILE_LINES_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER file_lines_act_iou
...
end file_lines_act_iou;
/
select 'FILE_LINES_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER file_lines_act_iod
   instead of delete on file_lines_act
   for each row
begin

   -- Trigger File_Lines_Act_Iod
...
end file_lines_act_iod;
/
select 'FILE_LINES_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  file_lines_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  file_lines%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if file_lines_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
      ...
      into n_id
       ...
       where (    n_id is not null
              and n_id = id       )
        or   (    n_file_id is not null
              and n_file_id = file_id
              and n_seq is not null
              and n_seq = seq
             );
   end if;
end ins;
...
begin
   ...
   update file_lines FL
     set  FL.file_id = n_file_id
         ,FL.seq = n_seq
         ,FL.value = n_value
         ,FL.aud_beg_dtm = n_aud_beg_dtm
         ,FL.aud_beg_usr = n_aud_beg_usr
    where FL.id = o_id;
   -- Set RETURNING VALUES if file_lines_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
begin
   n_buff.id := null;
   n_buff.file_id := null;
   n_buff.files_nk1 := null;
   n_buff.files_nk2 := null;
   n_buff.seq := null;
   n_buff.value := null;
end clear;
----------------------------------------
...
begin
   file_lines_dml.ins
      (n_id => n_buff.id
      ,n_file_id => n_buff.file_id
      ,n_seq => n_buff.seq
      ,n_value => n_buff.value
      );
end ins;
----------------------------------------
procedure upd
...
is
begin
   file_lines_pop.at_server(id_in);
end pop;
----------------------------------------
end file_lines_dml;
/
...
create view domains_act
   ...
   as select
      ...
      ,DOM.description
 from             domains DOM
       inner join applications_act APP on APP.id = DOM.application_id
/
...
create TRIGGER domains_act_ioi
...
/
select 'DOMAINS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'DOMAINS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER domains_act_iou
...
/
select 'DOMAINS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'DOMAINS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER domains_act_iod
   instead of delete on domains_act
   for each row
begin

   -- Trigger Domains_Act_Iod
...
/
select 'DOMAINS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'DOMAINS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  domains_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  domains%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if domains_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
...
begin
   ...
   update domains DOM
    ...
    where DOM.id = o_id;
   -- Set RETURNING VALUES if domains_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
create view domain_values_act
 ...
 from             domain_values DV
       inner join domains_act DOM on DOM.id = DV.domain_id
/
...
create TRIGGER domain_values_act_ioi
...
end domain_values_act_ioi;
/
select 'DOMAIN_VALUES_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'DOMAIN_VALUES_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER domain_values_act_iou
...
end domain_values_act_iou;
/
select 'DOMAIN_VALUES_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'DOMAIN_VALUES_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER domain_values_act_iod
   instead of delete on domain_values_act
   for each row
begin

   -- Trigger Domain_Values_Act_Iod
...
end domain_values_act_iod;
/
select 'DOMAIN_VALUES_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'DOMAIN_VALUES_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  domain_values_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  domain_values%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if domain_values_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
      ...
      into n_id
       ...
       where (    n_id is not null
              and n_id = id       )
        or   (    n_domain_id is not null
              and n_domain_id = domain_id
              and n_value is not null
              and n_value = value
             );
   end if;
end ins;
...
begin
   ...
   update domain_values DV
    ...
    where DV.id = o_id;
   -- Set RETURNING VALUES if domain_values_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
is
   retid  number;
begin
   select domain_values_seq.currval
    into  retid from dual;
   return retid;
end get_curr_id;
----------------------------------------
...
begin
   n_buff.id := null;
   n_buff.domain_id := null;
   n_buff.domains_nk1 := null;
   n_buff.domains_nk2 := null;
   n_buff.value := null;
   n_buff.seq := null;
   n_buff.description := null;
end clear;
...
create view tables_act
   ...
   as select
      ...
      ,TAB.description
 from             tables TAB
       inner join applications_act APP on APP.id = TAB.application_id
/
...
/
select 'TABLES_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'TABLES_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
/
select 'TABLES_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'TABLES_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER tables_act_iod
   instead of delete on tables_act
   for each row
begin

   -- Trigger Tables_Act_Iod
...
/
select 'TABLES_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'TABLES_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  tables_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  tables%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if tables_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
...
begin
   ...
   update tables TAB
    ...
    where TAB.id = o_id;
   -- Set RETURNING VALUES if tables_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
begin
   ...
   n_buff.seq := null;
   n_buff.type := null;
   n_buff.group_name := null;
   n_buff.mv_refresh_hr := null;
   n_buff.ts_onln_data := null;
   n_buff.ts_onln_indx := null;
   n_buff.ts_hist_data := null;
   n_buff.ts_hist_indx := null;
...
begin
   tables_dml.ins
      ...
      ,n_seq => n_buff.seq
      ,n_type => n_buff.type
      ,n_group_name => n_buff.group_name
      ,n_mv_refresh_hr => n_buff.mv_refresh_hr
      ,n_ts_onln_data => n_buff.ts_onln_data
      ,n_ts_onln_indx => n_buff.ts_onln_indx
      ,n_ts_hist_data => n_buff.ts_hist_data
      ,n_ts_hist_indx => n_buff.ts_hist_indx
      ,n_description => n_buff.description
      );
end ins;
----------------------------------------
...
create view tab_cols_act
   ...
   as select
      ...
      ,COL.fk_prefix
      ,COL.fk_table_id
      ,fk_TAB.applications_nk1
      ,fk_TAB.abbr
      ,COL.d_domain_id
      ,d_DOM.applications_nk1
      ,d_DOM.abbr
      ,COL.type
      ,COL.len
      ,COL.scale
      ...
      ,COL.description
 from             tab_cols COL
       inner join tables_act TAB on TAB.id = COL.table_id
  left outer join tables_act fk_TAB on fk_TAB.id = COL.fk_table_id
  left outer join domains_act d_DOM on d_DOM.id = COL.d_domain_id
/
...
create TRIGGER tab_cols_act_ioi
...
end tab_cols_act_ioi;
/
select 'TAB_COLS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'TAB_COLS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER tab_cols_act_iou
...
end tab_cols_act_iou;
/
select 'TAB_COLS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'TAB_COLS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER tab_cols_act_iod
   instead of delete on tab_cols_act
   for each row
begin

   -- Trigger Tab_Cols_Act_Iod
...
end tab_cols_act_iod;
/
select 'TAB_COLS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'TAB_COLS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  tab_cols_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  tab_cols%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if tab_cols_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
      ...
      into n_id
       ...
       where (    n_id is not null
              and n_id = id       )
        or   (    n_table_id is not null
              and n_table_id = table_id
              and n_name is not null
              and n_name = name
             );
   end if;
...
begin
   ...
   update tab_cols COL
    ...
    where COL.id = o_id;
   -- Set RETURNING VALUES if tab_cols_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
begin
   n_buff.id := null;
   n_buff.table_id := null;
   n_buff.tables_nk1 := null;
   n_buff.tables_nk2 := null;
   n_buff.name := null;
   n_buff.seq := null;
   n_buff.nk := null;
   n_buff.req := null;
   n_buff.fk_prefix := null;
   n_buff.fk_table_id := null;
   n_buff.fk_tables_nk1 := null;
   n_buff.fk_tables_nk2 := null;
   n_buff.d_domain_id := null;
   n_buff.d_domains_nk1 := null;
   n_buff.d_domains_nk2 := null;
   n_buff.type := null;
   n_buff.len := null;
   n_buff.scale := null;
   n_buff.fold := null;
   n_buff.default_value := null;
   n_buff.upd_res_pct := null;
   n_buff.description := null;
end clear;
----------------------------------------
procedure clear
...
begin
   tab_cols_dml.ins
      ...
      ,n_buff.fk_prefix
      ,n_buff.fk_table_id
      ,n_buff.fk_tables_nk1
      ,n_buff.fk_tables_nk2
      ,n_buff.d_domain_id
      ,n_buff.d_domains_nk1
      ,n_buff.d_domains_nk2
      ,n_buff.type
      ,n_buff.len
      ,n_buff.scale
      ,n_buff.fold
      ,n_buff.default_value
      ,n_buff.upd_res_pct
      ,n_buff.description
      );
end ins;
...
begin
   tab_cols_dml.ins
      (n_id => n_buff.id
      ,n_table_id => n_buff.table_id
      ,n_name => n_buff.name
      ,n_seq => n_buff.seq
      ,n_nk => n_buff.nk
      ,n_req => n_buff.req
      ,n_fk_prefix => n_buff.fk_prefix
      ,n_fk_table_id => n_buff.fk_table_id
      ,n_d_domain_id => n_buff.d_domain_id
      ,n_type => n_buff.type
      ,n_len => n_buff.len
      ,n_scale => n_buff.scale
      ,n_fold => n_buff.fold
      ,n_default_value => n_buff.default_value
      ,n_upd_res_pct => n_buff.upd_res_pct
      ,n_description => n_buff.description
      );
end ins;
----------------------------------------
...
create package tab_inds_view
is

   -- Package Tab_Inds_View
   --    View functions
   --    (DML, Foreign Keys, Paths, and )
   --
...
/
select 'TAB_INDS_VIEW' as "Package:"
 from  user_errors
 where name  = 'TAB_INDS_VIEW'
  and  type  = 'PACKAGE'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create view tab_inds_act
   ...
   as select
      ...
      ,IND.seq
 from             tab_inds IND
       inner join tab_cols_act COL on COL.id = IND.tab_col_id
/
select 'TAB_INDS_ACT' as "View:"
 from  user_errors
 where name  = 'TAB_INDS_ACT'
  and  type  = 'VIEW'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
comment on table tab_inds_act is 'Unique and non-unique indexes for this table'
/

comment on column tab_inds_act.id is 'Surrogate Primary Key for these tab_inds_act'
/
comment on column tab_inds_act.tab_col_id is 'Surrogate Key for the column for this index'
/
comment on column tab_inds_act.tag is 'Tag attached to the table name for this column that uniquely identifies this index'
/
comment on column tab_inds_act.seq is 'Sequence number for this column for this index'
/
comment on column tab_inds_act.tab_cols_nk1 is 'TAB_COLS Natural Key Value 1: Abbreviation for this application'
/
comment on column tab_inds_act.tab_cols_nk2 is 'TAB_COLS Natural Key Value 2: Abbreviation for this table'
/
comment on column tab_inds_act.tab_cols_nk3 is 'TAB_COLS Natural Key Value 3: Name of this column'
/

alter view tab_inds_act add constraint tab_inds_act_pk
   primary key (id) disable
/

alter view tab_inds_act add constraint tab_inds_act_fk1
   foreign key (tab_col_id) references tab_cols_act (id) disable
/

create TRIGGER tab_inds_act_ioi
   instead of insert on tab_inds_act
   for each row
declare
   n_id  NUMBER(38);
...
end tab_inds_act_ioi;
/
select 'TAB_INDS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'TAB_INDS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER tab_inds_act_iou
   instead of update on tab_inds_act
   for each row
declare
   n_tab_col_id  NUMBER(38);
   n_tag  VARCHAR2(4);
...
end tab_inds_act_iou;
/
select 'TAB_INDS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'TAB_INDS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER tab_inds_act_iod
   instead of delete on tab_inds_act
   for each row
begin

   -- Trigger Tab_Inds_Act_Iod
...
end tab_inds_act_iod;
/
select 'TAB_INDS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'TAB_INDS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create package tab_inds_dml
is

   -- Package Tab_Inds_Dml
   -- (Data Manipulation Language, Foreign Key and Path Lookup)
   ...
   function get_id
      (tab_inds_nk1  in  VARCHAR2
      ,tab_inds_nk2  in  VARCHAR2
      ,tab_inds_nk3  in  VARCHAR2
      ,tab_inds_nk4  in  VARCHAR2
      ,tab_inds_nk5  in  NUMBER
      ) return number;
   function get_nk
      (id_in  in  number
      ) return varchar2;
   ...
   procedure clear
      (n_buff  in out  tab_inds_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  tab_inds%ROWTYPE);
...
/
select 'TAB_INDS_DML' as "Package:"
 from  user_errors
 where name  = 'TAB_INDS_DML'
  and  type  = 'PACKAGE'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create package body tab_inds_view
is

-- Package Body Tab_Inds_View
--    View functions
--    (DML, Foreign Keys, Paths, and )
...
is
begin
   if util.db_object_exists('TAB_INDS', 'MATERIALIZED VIEW')
   then
      raise_application_error(-20010, 'Insert not allowed on materialized view tab_inds.  Inserts on tab_inds must be performed on the central database.');
   end if;
   ...
   -- Set RETURNING VALUES if tab_inds_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
      ...
      into n_id
       ...
       where (    n_id is not null
              and n_id = id       )
        or   (    n_tab_col_id is not null
              and n_tab_col_id = tab_col_id
              and n_tag is not null
              and n_tag = tag
              and n_seq is not null
              and n_seq = seq
             );
...
begin
   if util.db_object_exists('TAB_INDS', 'MATERIALIZED VIEW')
   then
      raise_application_error(-20010, 'Update not allowed on materialized view tab_inds.  Updates on tab_inds must be performed on the central database.');
   end if;
   -- Set n_tab_col_id, if needed
   ...
   update tab_inds IND
     set  IND.tab_col_id = n_tab_col_id
         ...
         ,IND.seq = n_seq
    where IND.id = o_id;
   -- Set RETURNING VALUES if tab_inds_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
begin
   if util.db_object_exists('TAB_INDS', 'MATERIALIZED VIEW')
   then
      raise_application_error(-20010, 'Delete not allowed on materialized view tab_inds.  Deletes on tab_inds must be performed on the central database.');
   end if;
   if not glob.get_db_constraints
   then
      tab_inds_tab.del
   ...
   delete from tab_inds IND
    where IND.id = o_id;
end del;
----------------------------------------
end tab_inds_view;
/
select 'TAB_INDS_VIEW' as "Package Body:"
 from  user_errors
 where name  = 'TAB_INDS_VIEW'
  and  type  = 'PACKAGE BODY'
  and  rownum = 1
...
create package body tab_inds_dml
is

 -- Package Body Tab_Inds_Dml
 -- (Data Manipulation Language, Foreign Key and Path Lookup)
...
begin
   select id
    ...
    where IND.tab_col_id = tab_cols_dml.get_id
     ...
     and  IND.tag = tab_inds_nk4
     and  IND.seq = tab_inds_nk5
    ;
   return retid;
exception
   when no_data_found
...
function tab_to_col
   ...
   return col_type
is
   -- This function is duplicated in tab_inds_POP
   cursor acur is
      select * from tab_inds
       where id = id_in;
   abuf   acur%ROWTYPE;
   rcol      col_type;
begin
...
begin
   n_buff.id := null;
   n_buff.tab_col_id := null;
   n_buff.tab_cols_nk1 := null;
   n_buff.tab_cols_nk2 := null;
   n_buff.tab_cols_nk3 := null;
   n_buff.tag := null;
   n_buff.seq := null;
end clear;
----------------------------------------
...
begin
   tab_inds_dml.ins
      (n_id => n_buff.id
      ,n_tab_col_id => n_buff.tab_col_id
      ,n_tag => n_buff.tag
      ,n_seq => n_buff.seq
      );
end ins;
...
/
select 'TAB_INDS_DML' as "Package Body:"
 from  user_errors
 where name  = 'TAB_INDS_DML'
  and  type  = 'PACKAGE BODY'
  and  rownum = 1
...
create view check_cons_act
   ...
   as select
      ...
      ,CK.description
 from             check_cons CK
       inner join tables_act TAB on TAB.id = CK.table_id
/
...
create TRIGGER check_cons_act_ioi
...
end check_cons_act_ioi;
/
select 'CHECK_CONS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'CHECK_CONS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER check_cons_act_iou
...
end check_cons_act_iou;
/
select 'CHECK_CONS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'CHECK_CONS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER check_cons_act_iod
   instead of delete on check_cons_act
   for each row
begin

   -- Trigger Check_Cons_Act_Iod
...
end check_cons_act_iod;
/
select 'CHECK_CONS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'CHECK_CONS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  check_cons_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  check_cons%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if check_cons_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
...
begin
   ...
   update check_cons CK
    ...
    where CK.id = o_id;
   -- Set RETURNING VALUES if check_cons_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
create view programs_act
   ...
   as select
      ...
      ,PRG.description
 from             programs PRG
       inner join applications_act APP on APP.id = PRG.application_id
/
...
create TRIGGER programs_act_ioi
...
end programs_act_ioi;
/
select 'PROGRAMS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'PROGRAMS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER programs_act_iou
...
end programs_act_iou;
/
select 'PROGRAMS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'PROGRAMS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER programs_act_iod
   instead of delete on programs_act
   for each row
begin

   -- Trigger Programs_Act_Iod
...
end programs_act_iod;
/
select 'PROGRAMS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'PROGRAMS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  programs_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  programs%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if programs_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
...
begin
   ...
   update programs PRG
    ...
    where PRG.id = o_id;
   -- Set RETURNING VALUES if programs_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
create view exceptions_act
   ...
   as select
      ...
      ,EXC.action
 from             exceptions EXC
       inner join applications_act APP on APP.id = EXC.application_id
/
...
create TRIGGER exceptions_act_ioi
...
end exceptions_act_ioi;
/
select 'EXCEPTIONS_ACT_IOI' as "Trigger:"
 from  user_errors
 where name  = 'EXCEPTIONS_ACT_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER exceptions_act_iou
...
end exceptions_act_iou;
/
select 'EXCEPTIONS_ACT_IOU' as "Trigger:"
 from  user_errors
 where name  = 'EXCEPTIONS_ACT_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create TRIGGER exceptions_act_iod
   instead of delete on exceptions_act
   for each row
begin

   -- Trigger Exceptions_Act_Iod
...
end exceptions_act_iod;
/
select 'EXCEPTIONS_ACT_IOD' as "Trigger:"
 from  user_errors
 where name  = 'EXCEPTIONS_ACT_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
is
   ...
   procedure clear
      (n_buff  in out  exceptions_ACT%ROWTYPE);
   procedure clear
      (n_buff  in out  exceptions%ROWTYPE);
...
begin
   ...
   -- Set RETURNING VALUES if exceptions_TAB.ins was not run
   -- NOTE: returning values clause on insert will not work over DB Link
   if glob.get_db_constraints
   then
      select id
...
begin
   ...
   update exceptions EXC
     set  EXC.application_id = n_application_id
         ...
         ,EXC.action = n_action
    where EXC.id = o_id;
   -- Set RETURNING VALUES if exceptions_TAB.upd was not run
   -- NOTE: returning values clause on update will not work over DB Link
   if glob.get_db_constraints
   then
      select 'X'
...
begin
   exceptions_dml.ins
      ...
      ,n_code => n_buff.code
      ,n_name => n_buff.name
      ,n_message => n_buff.message
      ,n_cause => n_buff.cause
      ,n_action => n_buff.action
      );
end ins;
----------------------------------------
procedure upd
...
create view files_all
 ...
 union all select
      ...
      ,F.aud_end_dtm
 from             files_AUD F
  left outer join applications_ACT APP on APP.id = F.application_id
 where last_active = 'Y'
 union all select
       F.files_id
      ,'POP'
      ...
      ,F.description
      ,F.aud_beg_usr
      ,F.pop_usr aud_end_usr
      ,F.aud_beg_dtm
      ,F.pop_dtm aud_end_dtm
 from             files_PDAT F
  left outer join applications_ACT APP on APP.id = F.application_id
 where pop_dml = 'INSERT'
/
select 'FILES_ALL' as "View:"
 from  user_errors
 where name  = 'FILES_ALL'
  and  type  = 'VIEW'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
comment on table files_all is 'Active and Deleted Files for capturing scripts and logs.  NOTE: Deleted records in this view with missing FK data for a non-null FK ID cannot be "popped"'
/

comment on column files_all.id is 'Surrogate Primary Key for this table'
/
comment on column files_all.stat is 'ACT for active records, DEL for deleted records'
/
comment on column files_all.application_id is 'Surrogate Key for the application of this file'
/
comment on column files_all.applications_nk1 is 'APPLICATIONS Natural Key Value 1: Abbreviation for this application'
/
comment on column files_all.name is 'Name of this file'
/
comment on column files_all.type is 'Type for this file'
/
comment on column files_all.created_dt is 'Time/Date this file was created/updated'
/
comment on column files_all.description is 'Description for this file'
/
comment on column files_all.aud_beg_usr is 'User that created this record'
/
comment on column files_all.aud_end_usr is 'User that deleted this record'
/
comment on column files_all.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
comment on column files_all.aud_end_dtm is 'Date/Time this record was deleted (must be in nanoseconds)'
/

alter view files_all add constraint files_all_pk
   primary key (id) disable
/

alter view files_all add constraint files_all_fk1
   foreign key (application_id) references applications_act (id) disable
/

create trigger files_all_ioi
   instead of insert on files_all
   for each row
begin

   -- Trigger Files_All_Ioi

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_all_ioi');
   raise_application_error(-20001,
      'files_all_ioi:insert is not allowed on this view.');

end files_all_ioi;
/
select 'FILES_ALL_IOI' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ALL_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger files_all_iou
   instead of update on files_all
   for each row
begin

   -- Trigger Files_All_Iou

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_all_iou');
   raise_application_error(-20001,
      'files_all_iou:update is not allowed on this view.');

end files_all_iou;
/
select 'FILES_ALL_IOU' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ALL_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger files_all_iod
   instead of delete on files_all
   for each row
begin

   -- Trigger Files_All_Iod

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_all_iod');
   raise_application_error(-20001,
      'files_all_iod:delete is not allowed on this view.');

end files_all_iod;
/
select 'FILES_ALL_IOD' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ALL_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create view files_asof
   ...
   as select
      ...
      ,null
 from files_ACT
 where aud_beg_dtm <= glob.get_asof_dtm
 union all select
       F.files_id
      ,'AUD'
      ,F.application_id
 ...
 from             files_AUD F
  left outer join applications_ACT APP on APP.id = F.application_id
 where F.aud_beg_dtm <= glob.get_asof_dtm
  and  F.aud_end_dtm >  glob.get_asof_dtm
/
select 'FILES_ASOF' as "View:"
 from  user_errors
 where name  = 'FILES_ASOF'
  and  type  = 'VIEW'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
comment on table files_asof is 'AS OF glob.get_asof_dtm Files for capturing scripts and logs'
/

comment on column files_asof.id is 'Surrogate Primary Key for this table'
/
comment on column files_asof.application_id is 'AS OF Surrogate Key for the application of this file'
/
comment on column files_asof.applications_nk1 is 'AS OF APPLICATIONS Natural Key Value 1: Abbreviation for this application'
/
comment on column files_asof.name is 'AS OF Name of this file'
/
comment on column files_asof.type is 'AS OF Type for this file'
/
comment on column files_asof.created_dt is 'AS OF Time/Date this file was created/updated'
/
comment on column files_asof.description is 'AS OF Description for this file'
/
comment on column files_asof.aud_beg_usr is 'User that created this record'
/
comment on column files_asof.aud_end_usr is 'User that deleted this record'
/
comment on column files_asof.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
comment on column files_asof.aud_end_dtm is 'Date/Time this record was deleted (must be in nanoseconds)'
/

alter view files_asof add constraint files_asof_pk
   primary key (id) disable
/

alter view files_asof add constraint files_asof_fk1
   foreign key (application_id) references applications_act (id) disable
/

create trigger files_asof_ioi
   instead of insert on files_asof
   for each row
begin

   -- Trigger Files_Asof_Ioi

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_asof_ioi');
   raise_application_error(-20001,
      'files_asof_ioi:insert is not allowed on this view.');

end files_asof_ioi;
/
select 'FILES_ASOF_IOI' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ASOF_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger files_asof_iou
   instead of update on files_asof
   for each row
begin

   -- Trigger Files_Asof_Iou

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_asof_iou');
   raise_application_error(-20001,
      'files_asof_iou:update is not allowed on this view.');

end files_asof_iou;
/
select 'FILES_ASOF_IOU' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ASOF_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger files_asof_iod
   instead of delete on files_asof
   for each row
begin

   -- Trigger Files_Asof_Iod

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger files_asof_iod');
   raise_application_error(-20001,
      'files_asof_iod:delete is not allowed on this view.');

end files_asof_iod;
/
select 'FILES_ASOF_IOD' as "Trigger:"
 from  user_errors
 where name  = 'FILES_ASOF_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create view file_lines_all
 ...
 union all select
      ...
      ,FL.aud_beg_dtm
      ,FL.aud_end_dtm
 from             file_lines_AUD FL
  left outer join files_ALL F on F.id = FL.file_id
 where last_active = 'Y'
 union all select
       FL.file_lines_id
      ,'POP'
      ...
      ,FL.value
      ,FL.aud_beg_usr
      ,FL.pop_usr aud_end_usr
      ,FL.aud_beg_dtm
      ,FL.pop_dtm aud_end_dtm
 from             file_lines_PDAT FL
  left outer join files_ALL F on F.id = FL.file_id
 where pop_dml = 'INSERT'
/
select 'FILE_LINES_ALL' as "View:"
 from  user_errors
 where name  = 'FILE_LINES_ALL'
  and  type  = 'VIEW'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
comment on table file_lines_all is 'Active and Deleted Lines for files.  NOTE: Deleted records in this view with missing FK data for a non-null FK ID cannot be "popped"'
/

comment on column file_lines_all.id is 'Surrogate Primary Key for this table'
/
comment on column file_lines_all.stat is 'ACT for active records, DEL for deleted records'
/
comment on column file_lines_all.file_id is 'Surrogate Key for the file of this line'
/
comment on column file_lines_all.files_nk1 is 'FILES Natural Key Value 1: Abbreviation for this application'
/
comment on column file_lines_all.files_nk2 is 'FILES Natural Key Value 2: Name of this file'
/
comment on column file_lines_all.seq is 'Sequence number for this line in the file'
/
comment on column file_lines_all.value is 'Value or contents of this line in the file'
/
comment on column file_lines_all.aud_beg_usr is 'User that created this record'
/
comment on column file_lines_all.aud_end_usr is 'User that deleted this record'
/
comment on column file_lines_all.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
comment on column file_lines_all.aud_end_dtm is 'Date/Time this record was deleted (must be in nanoseconds)'
/

alter view file_lines_all add constraint file_lines_all_pk
   primary key (id) disable
/

alter view file_lines_all add constraint file_lines_all_fk1
   foreign key (file_id) references files_act (id) disable
/

create trigger file_lines_all_ioi
   instead of insert on file_lines_all
   for each row
begin

   -- Trigger File_Lines_All_Ioi

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_all_ioi');
   raise_application_error(-20001,
      'file_lines_all_ioi:insert is not allowed on this view.');

end file_lines_all_ioi;
/
select 'FILE_LINES_ALL_IOI' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ALL_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger file_lines_all_iou
   instead of update on file_lines_all
   for each row
begin

   -- Trigger File_Lines_All_Iou

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_all_iou');
   raise_application_error(-20001,
      'file_lines_all_iou:update is not allowed on this view.');

end file_lines_all_iou;
/
select 'FILE_LINES_ALL_IOU' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ALL_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger file_lines_all_iod
   instead of delete on file_lines_all
   for each row
begin

   -- Trigger File_Lines_All_Iod

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_all_iod');
   raise_application_error(-20001,
      'file_lines_all_iod:delete is not allowed on this view.');

end file_lines_all_iod;
/
select 'FILE_LINES_ALL_IOD' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ALL_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create view file_lines_asof
 ...
 union all select
      ...
      ,FL.aud_end_dtm
 from             file_lines_AUD FL
  left outer join files_ASOF F on F.id = FL.file_id
 where FL.aud_beg_dtm <= glob.get_asof_dtm
  and  FL.aud_end_dtm >  glob.get_asof_dtm
/
select 'FILE_LINES_ASOF' as "View:"
 from  user_errors
 where name  = 'FILE_LINES_ASOF'
  and  type  = 'VIEW'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
comment on table file_lines_asof is 'AS OF glob.get_asof_dtm Lines for files'
/

comment on column file_lines_asof.id is 'Surrogate Primary Key for this table'
/
comment on column file_lines_asof.file_id is 'AS OF Surrogate Key for the file of this line'
/
comment on column file_lines_asof.files_nk1 is 'AS OF FILES Natural Key Value 1: Abbreviation for this application'
/
comment on column file_lines_asof.files_nk2 is 'AS OF FILES Natural Key Value 2: Name of this file'
/
comment on column file_lines_asof.seq is 'AS OF Sequence number for this line in the file'
/
comment on column file_lines_asof.value is 'AS OF Value or contents of this line in the file'
/
comment on column file_lines_asof.aud_beg_usr is 'User that created this record'
/
comment on column file_lines_asof.aud_end_usr is 'User that deleted this record'
/
comment on column file_lines_asof.aud_beg_dtm is 'Date/Time this record was created (must be in nanoseconds)'
/
comment on column file_lines_asof.aud_end_dtm is 'Date/Time this record was deleted (must be in nanoseconds)'
/

alter view file_lines_asof add constraint file_lines_asof_pk
   primary key (id) disable
/

alter view file_lines_asof add constraint file_lines_asof_fk1
   foreign key (file_id) references files_act (id) disable
/

create trigger file_lines_asof_ioi
   instead of insert on file_lines_asof
   for each row
begin

   -- Trigger File_Lines_Asof_Ioi

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_asof_ioi');
   raise_application_error(-20001,
      'file_lines_asof_ioi:insert is not allowed on this view.');

end file_lines_asof_ioi;
/
select 'FILE_LINES_ASOF_IOI' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ASOF_IOI'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger file_lines_asof_iou
   instead of update on file_lines_asof
   for each row
begin

   -- Trigger File_Lines_Asof_Iou

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_asof_iou');
   raise_application_error(-20001,
      'file_lines_asof_iou:update is not allowed on this view.');

end file_lines_asof_iou;
/
select 'FILE_LINES_ASOF_IOU' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ASOF_IOU'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
...
create trigger file_lines_asof_iod
   instead of delete on file_lines_asof
   for each row
begin

   -- Trigger File_Lines_Asof_Iod

   -- Application: Dtgen For Oracle
   -- Generated by DTGen (http://code.google.com/p/dtgen)
   -- October   08, 2012  12:15:52 PM

   -- util.log('Trigger file_lines_asof_iod');
   raise_application_error(-20001,
      'file_lines_asof_iod:delete is not allowed on this view.');

end file_lines_asof_iod;
/
select 'FILE_LINES_ASOF_IOD' as "Trigger:"
 from  user_errors
 where name  = 'FILE_LINES_ASOF_IOD'
  and  type  = 'TRIGGER'
  and  rownum = 1
/
select '('||line||'/'||position||') '||text as error
